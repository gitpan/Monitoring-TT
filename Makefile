...
#     NO_META => q[1]
#     PREREQ_PM => { Test::Pod::Coverage=>q[0], Test::Cmd=>q[0], ExtUtils::MakeMaker=>q[6.36], Perl::Critic::Policy::NamingConventions::ProhibitMixedCaseSubs=>q[0], Template=>q[0], Perl::Critic::Policy::ValuesAndExpressions::ProhibitAccessOfPrivateData=>q[0], File::BOM=>q[0], Test::Pod=>q[1.4], Test::Perl::Critic=>q[0], Perl::Critic::Policy::Dynamic::NoIndirect=>q[0] }
#     VERSION => q[1.0.0]
...
MAKEMAKER   = /home/sven/perl5/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.62
MM_REVISION = 66200
...
MAKE = make
FULLEXT = Monitoring/TT
BASEEXT = TT
PARENT_NAME = Monitoring
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Monitoring/TT.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Monitoring/TT.pm \
	lib/Monitoring/TT/Identifier.pm \
	lib/Monitoring/TT/Input/CSV.pm \
	lib/Monitoring/TT/Input/Nagios.pm \
	lib/Monitoring/TT/Log.pm \
	lib/Monitoring/TT/Object.pm \
	lib/Monitoring/TT/Object/Contact.pm \
	lib/Monitoring/TT/Object/Host.pm \
	lib/Monitoring/TT/Render.pm \
	lib/Monitoring/TT/Utils.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Monitoring
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Monitoring
...
TO_INST_PM = lib/Monitoring/TT.pm \
	lib/Monitoring/TT/Identifier.pm \
	lib/Monitoring/TT/Input/CSV.pm \
	lib/Monitoring/TT/Input/Nagios.pm \
	lib/Monitoring/TT/Log.pm \
...
PM_TO_BLIB = lib/Monitoring/TT/Input/Nagios.pm \
	...
	lib/Monitoring/TT/Object/Contact.pm \
	blib/lib/Monitoring/TT/Object/Contact.pm \
	lib/Monitoring/TT.pm \
	blib/lib/Monitoring/TT.pm \
	lib/Monitoring/TT/Utils.pm \
	blib/lib/Monitoring/TT/Utils.pm \
	lib/Monitoring/TT/Object.pm \
...
DISTNAME = Monitoring-TT
DISTVNAME = Monitoring-TT-1.0.0
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Monitoring/TT/Input/Nagios.pm $(INST_MAN3DIR)/Monitoring::TT::Input::Nagios.$(MAN3EXT) \
	  lib/Monitoring/TT/Object/Host.pm $(INST_MAN3DIR)/Monitoring::TT::Object::Host.$(MAN3EXT) \
	  lib/Monitoring/TT/Render.pm $(INST_MAN3DIR)/Monitoring::TT::Render.$(MAN3EXT) \
	  lib/Monitoring/TT/Input/CSV.pm $(INST_MAN3DIR)/Monitoring::TT::Input::CSV.$(MAN3EXT) \
	  lib/Monitoring/TT/Object/Contact.pm $(INST_MAN3DIR)/Monitoring::TT::Object::Contact.$(MAN3EXT) \
	  lib/Monitoring/TT.pm $(INST_MAN3DIR)/Monitoring::TT.$(MAN3EXT) \
	  lib/Monitoring/TT/Utils.pm $(INST_MAN3DIR)/Monitoring::TT::Utils.$(MAN3EXT) \
	  lib/Monitoring/TT/Identifier.pm $(INST_MAN3DIR)/Monitoring::TT::Identifier.$(MAN3EXT) \
	  lib/Monitoring/TT/Log.pm $(INST_MAN3DIR)/Monitoring::TT::Log.$(MAN3EXT) \
	  lib/Monitoring/TT/Object.pm $(INST_MAN3DIR)/Monitoring::TT::Object.$(MAN3EXT) 
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="1.0.0">' > $(DISTNAME).ppd
...
upgradedeps ::
	$(PERL) Makefile.PL --config= --upgradedeps=Template,0,File::BOM,0,Test::Cmd,0,Test::Pod,1.4,Test::Perl::Critic,0,Test::Pod::Coverage,0,Perl::Critic::Policy::Dynamic::NoIndirect,0,Perl::Critic::Policy::NamingConventions::ProhibitMixedCaseSubs,0,Perl::Critic::Policy::ValuesAndExpressions::ProhibitAccessOfPrivateData,0

upgradedeps_notest ::
	$(PERL) Makefile.PL --config=notest,1 --upgradedeps=Template,0,File::BOM,0,Test::Cmd,0,Test::Pod,1.4,Test::Perl::Critic,0,Test::Pod::Coverage,0,Perl::Critic::Policy::Dynamic::NoIndirect,0,Perl::Critic::Policy::NamingConventions::ProhibitMixedCaseSubs,0,Perl::Critic::Policy::ValuesAndExpressions::ProhibitAccessOfPrivateData,0

listdeps ::
	@$(PERL) -le "print for @ARGV" 

listalldeps ::
	@$(PERL) -le "print for @ARGV" Template File::BOM Test::Cmd Test::Pod Test::Perl::Critic Test::Pod::Coverage Perl::Critic::Policy::Dynamic::NoIndirect Perl::Critic::Policy::NamingConventions::ProhibitMixedCaseSubs Perl::Critic::Policy::ValuesAndExpressions::ProhibitAccessOfPrivateData
